		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Data Binding",
									"targetURL": "#sapdatabinding2project3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapdatabinding2project3-display": {
								"semanticObject": "sapdatabinding2project3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.databinding2.project3",
									"url": sap.ui.require.toUrl("sap/databinding2/project3")
								}
							}
						}
					}
